                    ...
                    <div className="flex flex-col justify-between w-72 border-r border-gray-300">
                        <div>
                            ...
                            <div className="text-center">
                                <Link onMouseEnter={()=>{setHover(true)}}  onMouseLeave={()=>{setHover(false)}} href="/tool" className="px-8 py-5 flex items-center gap-2 text-md text-gray-900 hover:bg-gray-100 hover:text-violet-500">
                                    <svg className="w-6 h-6 " xmlns="http://www.w3.org/2000/svg" fill={hover?"#000300":"none"} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18.75 10.5h.008v.008h-.008V10.5z" />
                                    </svg>
                                    Portrait Tool
                                </Link>
                                <Link onMouseEnter={()=>{setHover2(true)}}  onMouseLeave={()=>{setHover2(false)}} href="/" className="px-8 py-5 flex items-center gap-2 text-md text-gray-900 hover:bg-gray-100 hover:text-violet-500">
                                    <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill={hover2?"#000300":"none"} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" />
                                    </svg>
                                    How It Works
                                </Link>
                                <Link onMouseEnter={()=>{setHover3(true)}}  onMouseLeave={()=>{setHover3(false)}} href="/" className="px-8 py-5 flex items-center gap-2 text-md text-gray-900 hover:bg-gray-100 hover:text-violet-500">
                                    <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill={hover3?"#000300":"none"}  viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 19.5v-.75a7.5 7.5 0 00-7.5-7.5H4.5m0-6.75h.75c7.87 0 14.25 6.38 14.25 14.25v.75M6 18.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                                    </svg>
                                    Blog
                                </Link>
                                <a onMouseEnter={()=>{setHover4(true)}}  onMouseLeave={()=>{setHover4(false)}} href="https://github.com/brandonbyr4/comicfun" target="_blank" rel="noopener noreferrer" className="px-8 py-5 flex items-center gap-2 text-md text-gray-900 hover:bg-gray-100 hover:text-violet-500">
                                    <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill={hover4?"#000300":"none"} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                        ...
                        <svg className="w-8 h-8 m-8 text-violet-500 hover:fill-current hover:text-black cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
